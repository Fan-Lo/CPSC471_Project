...
CREATE TABLE PATIENT (
    ...
    CONSTRAINT HEADFK FOREIGN KEY (HeadAHC) REFERENCES PATIENT(AHC) ON DELETE SET NULL ON UPDATE CASCADE
);
...
(
    ...
    Pass		VARCHAR(25),
    FOREIGN KEY (Username) REFERENCES PATIENT(AHC) ON DELETE CASCADE
);
...
(
	Username 	CHAR(9) NOT NULL,
    Pass		VARCHAR(25),
    FOREIGN KEY (Username) REFERENCES EMPLOYEE(SIN)
);
